    ...
    return (
        <div className="relative" ref={dropdownRef}>
            <Button
                variant="outline"
                size="icon"
                className="h-10 w-10 border-slate-200 text-slate-700 bg-background-white hover:bg-slate-50 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-200 dark:hover:bg-slate-700 rounded-full"
            ...
            {isOpen && (
                <div className="absolute top-full right-0 mt-2 w-40 bg-background-white dark:bg-slate-800 rounded-xl shadow-xl border border-slate-100 dark:border-slate-700 py-1 z-50 animate-in fade-in zoom-in-95 duration-100 origin-top-right">
                    <button
