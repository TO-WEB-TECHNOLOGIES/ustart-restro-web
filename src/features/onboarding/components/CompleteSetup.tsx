            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
                ...
                >
                    <TabsList className="bg-white border border-slate-200 p-1 rounded-xl h-12">
                        <TabsTrigger value="single" className="rounded-lg px-6 data-[state=active]:bg-slate-100 data-[state=active]:shadow-none text-slate-600">
                            {t('onboarding.restaurant.complete.singleRestro', 'I have only single Restaurant')}
                        </TabsTrigger>
                        <TabsTrigger value="multi" className="rounded-lg px-6 data-[state=active]:bg-slate-100 data-[state=active]:shadow-none text-slate-600">
                ...
                <div className="p-8 px-0 flex-grow">
                    ...
                    {isLoadingRestros ? (
                        <div className="flex flex-col items-center justify-center py-20 gap-4">
                            ...
                            <p className="text-slate-400 font-medium">Fetching your restaurants...</p>
                        </div>
                    ) : (
                        <div className="flex flex-col gap-6 w-full">
                            {restaurants.map(restro => (
                                <RestaurantCard key={restro.restroId} restaurant={restro} />
                            ))}
