            ...
            <div className="relative flex-1 md:flex-none" ref={filterRef}>
              ...
              {showFilters && (
                ...
                >
                  ...
                  {/* 1. Stock Status */}
                  <div className="mb-4">
                    <span className="text-[10px] font-bold text-slate-500 block mb-2 uppercase tracking-tight">
                      {t("dashboard.menuEditor.filter.stockStatus")}
                    </span>
                    <div className="flex flex-wrap gap-2">
                      {[
                        {
                          label: t("dashboard.menuEditor.filter.inStock"),
                          value: "in_stock",
                        },
                        {
                          label: t("dashboard.menuEditor.filter.outOfStock"),
                          value: "out_of_stock",
                        },
                      ].map((opt) => (
                        <button
                    ...
                    <div className="flex flex-wrap gap-2">
                      {[
                        ...
                        <button
                          key={opt.value}
                          onClick={() =>
                            toggleStagedFilter("foodType", opt.value)
                          }
                  ...
                  <div className="mb-6">
                    <span className="text-[10px] font-bold text-slate-500 block mb-2 uppercase tracking-tight">
                      {t("dashboard.menuEditor.filter.pricing")}
                    </span>
                    <div className="grid grid-cols-2 gap-2">
                      {[
                        {
                          label: t("dashboard.menuEditor.filter.discounted"),
                          value: true,
                        },
                        {
                          label: t("dashboard.menuEditor.filter.noDiscount"),
                          value: false,
                        },
                      ].map((opt) => (
                        <button
                          ...
                          onClick={() =>
                            setStagedFilters({
                              ...stagedFilters,
                              discounted:
                                stagedFilters.discounted === opt.value
                                  ? null
                                  : opt.value,
                            })
                          }
        ...
        <div className="w-full px-4 md:px-8 py-4">
          ...
          <div className="mb-6 md:mb-8 flex items-start justify-between">
            <div className="flex flex-col">
              ...
              <p
                className={`text-sm md:text-base mt-2 w-full max-w-5xl leading-relaxed ${selectedCategory.description ? "text-slate-500 dark:text-slate-400" : "text-orange-500 dark:text-orange-400 font-medium italic"} `}
              >
                {selectedCategory.description ||
                  t("dashboard.menuEditor.noDescription")}
              </p>
            </div>
